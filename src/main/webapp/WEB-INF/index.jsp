...
<h5 class="text">з метою виявлення проблем та покращення якості матеріально-технічного забезпечення:</h5>
...
if (dropdownValue === 'Оберіть відповідь'){
    ...
    function validateSelects()
    {
        ...
        if ( $('#sel1').val() !== '' && $('#sel2').val().length !== 0 && $('#sel3').val() !== '' && $('#sel4').val() !== ''){  m=true; }
        else{
